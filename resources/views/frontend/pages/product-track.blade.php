            ...
            <div class="wsus__track_area">
                <div class="row">
                    <div class="col-xl-5 col-md-10 col-lg-8 m-auto">
                        <form class="tack_form" action="{{route('product-tracking.index')}}">
                            ...
                            <div class="wsus__track_input">
                                ...
                                <input type="text" name="tracker" placeholder="H25-21578455" value="{{@$order->invocie_id}}">
                            </div>
                            ...
                            <ul class="progtrckr" data-progtrckr-steps="4">
                                ...
                                @if (@$order->order_status == 'canceled')
                                    ...
                                    @else
                                        ...
                                        @$order->order_status == 'dropped_off' || @$order->order_status == 'shipped' ||
