        ...
        <div class="card-body">
            <form action="{{route('admin.homepage-banner-secion-one')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="banner_old_image" value="{{asset($homepage_secion_banner_one->banner_one->banner_image)}}">
                </div>
                <div class="form-group">
                    <label>Banner url</label>
                    <input type="text" class="form-control" name="banner_url" value="{{asset($homepage_secion_banner_one->banner_one->banner_url)}}">
                </div>
