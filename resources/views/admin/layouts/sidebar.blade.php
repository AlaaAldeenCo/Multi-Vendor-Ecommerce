<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown {{setActive(['admin.vendor-profile.*', 'admin.coupons.*', 'admin.flash-sale.*', 'admin.shipping-rule.*', 'admin.payment-settings.*'])}}">
        ...
        <li
                class="dropdown {{ setActive(['admin.customer.index', 'admin.vendor-requests.index',
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.admin-list.index']) }}"><a class="nav-link" href="{{ route('admin.admin-list.index') }}">Admin Lists</a></li>
        ...
        <li class="dropdown {{setActive(['admin.slider.*', 'admin.home.page.setting',
         'admin.vendor-condition.index', 'admin.about.index', 'admin.terms-and-conditions.index'])}}">
        ...
        <li><a class="nav-link {{ setActive(['admin.advertisement.*']) }}" href="{{route('admin.advertisement.index')}}"><i class="fas fa-ad"></i><span>Advertisement</span></a></li>
